...
function Faq() {
  return (
    <main className="flex px-[70px]  pb-10 relative z-20 text-white h-auto justify-between  items-center w-full ">
                ...
                quests.map((d,id) =>{
                    return(
                        <div className='bb relative flex py-3 '>
                            <p className='text-[15px]'>{d.ques}</p>
      ...
      <div className="relative z-20   flex items-end justify-end  ">
        <img src={ques} className="h-[600px] " alt="" />
      </div>
    </main>
  );
}
