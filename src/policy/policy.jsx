    ...
    <div className="flex text-white items-center justify-center flex-wrap mt-20 gap-6">
      <div className="">
        <div className="sm:text-start text-center">
          ...
          <p className="font-[300] sm:px-0 px-3 sm:w-[80%] text-[13px] mt-6  ">
            Below are our privacy & policy, which outline a lot of goodies. it’s{" "}
            our aim to always take of our participant
          </p>
        </div>
        <div className="  sm:block flex items-center justify-center">
          <div className="box mt-12 h-auto sm:w-[500px]  w-[87%] sm:px-12 px-6 py-12  ">
            <p className="text-[14px] sm:text-start text-center leading-[30px] font-[400] ">
      ...
      <div>
        <img className="sm:h-[900px] h-[600px] " src={policy} alt="" />
      </div>
    </div>
  );
}
